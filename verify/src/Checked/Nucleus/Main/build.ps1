...
_boogie -out $OBJ\EntryMS_i.v $SPECS $AXIOMS $BASES $GC\Reach_i.bpl $GC\Common_i.bpl $GC\MarkSweepCollector_i.bpl $OBJ\EntryMS_i.bpl
_boogie -out $OBJ\EntryMS.v   $SPECS $AXIOMS $BASES $GC\Reach_i.bpl $GC\Common_i.bpl $GC\MarkSweepCollector_i.bpl $OBJ\EntryMS_i.bpl $SPEC\word_axioms.bpl $OBJ\EntryMS.bpl

_boogie -out $OBJ\EntryCP_i.v $SPECS $AXIOMS $BASES $GC\Reach_i.bpl $GC\Common_i.bpl $GC\CopyingCollector_i.bpl   $OBJ\EntryCP_i.bpl
_boogie -out $OBJ\EntryCP.v   $SPECS $AXIOMS $BASES $GC\Reach_i.bpl $GC\Common_i.bpl $GC\CopyingCollector_i.bpl   $OBJ\EntryCP_i.bpl $SPEC\word_axioms.bpl $OBJ\EntryCP.bpl
